...
if validation_preconisation == "Oui":
    ...
    if validation_schema == "Oui":
        ...
        nb_compresseur = st.text_input("La machine contient combien de CP ?")
        ...
        st.header("Masse du fluide frigorigène (en kg)")
        charge_frigorigene = st.number_input("Renseignez la charge du fluide frigorigène de l'installation ?")
        ...
        if st.button("Générer le rapport PDF"):
            html = f"""
                <html>
                    ...
                    <body>
                        <h1 style= "text-align: center;">Rapport de mise en service</h1>
                        <h1>I. Avant Démarrage de la machine</h1>
                        ...
                        <h2>Informations sur l'installateur</h2>
                        <ul>
                        ...
                        <h1>II. Démarrage de la mise en service</h1>
                        <ul>
                        ...
                        <h1>Masse du fluide frigorigène (en kg)</h1>
                        <ul>
                            <li>Renseignez la charge du fluide frigorigène de l'installation ?: {charge_frigorigene}</li>
                        </ul>
                    </body>
                </html>
            """

            nom_fichier = f'{datetime.today().day}-{datetime.today().month}-{datetime.today().year}_Rapport_mise_en_service.pdf'
